...
import com.andressantibanez.vimofit.model.responses.AlbumsGetWatchLaterResponse;
...
public class AlbumsEndpoint extends BaseEndpoint {
    ...
    public AlbumsEndpoint(OAuthConsumer consumer, RestAdapter.LogLevel logLevel) {
